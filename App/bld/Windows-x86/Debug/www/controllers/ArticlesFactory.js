...
function ArticlesFactory($http, strg, $q, $filter) {

    var factory = {};
    var dataBaseUrl = 'http://www.riderpro.nl/content/app.ashx';
    var articles = null;
    var categories = null;
...
angular.module('Amazilia').factory('ArticlesFactory', ['$http', 'localStorageService', '$q', '$filter', ArticlesFactory]);