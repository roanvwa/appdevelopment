...
// Global settings, todo : fill in the settings
var settings = {
    host: '',                           // Hostname site
    appName : '',                       // Name of the app
    storagePrefix: 'vwa'                // prefix for storrage
}
...
app.config(function ($routeProvider, localStorageServiceProvider) {
    ...
    // todo: set appname
    localStorageServiceProvider.setPrefix(settings.storagePrefix);
});
